"""
Cria o banco de dados e executa todos os scripts de população na ordem correta.
...
def executar_script(nome, env=None):
...
def main():
    ...
    print(f"\n── Executando {len(SCRIPTS_ORDEM)} scripts de população " + "─" * 14)
    ...
    for i, script in enumerate(SCRIPTS_ORDEM, 1):
        ...
        resultados[script] = executar_script(script)
